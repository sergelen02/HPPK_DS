...
func evalLin(a0,a1,x,p *big.Int)*big.Int{
	t := new(big.Int).Mul(a1,x); t.Add(t,a0); return mod(t,p)
}
...
func Sign(pp *Params, sk *SecretKey, msg []byte) (*Signature, error) {
	...
	r2Inv := invMod(sk.R2, sk.S2); if r2Inv==nil { return nil, ErrNoInverse("R2,S2") }
	r1Inv := invMod(sk.R1, sk.S1); if r1Inv==nil { return nil, ErrNoInverse("R1,S1") }
